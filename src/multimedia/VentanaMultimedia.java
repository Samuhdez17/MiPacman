...
public class VentanaMultimedia extends JFrame implements Lienzo {
    ...
    public void marcarPixel(int col, int fil, Color color) {
    ...
    public void dibujarImagen(int col, int fil, Image imagen) {
        imagenG2D.drawImage(imagen, col*tamPixel, fil*tamPixel, null);
    }

    public void escribirTexto(int col, int fil, String texto, Color color) {
        /*
